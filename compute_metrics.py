...
def compute_metrics(cleanFile, enhancedFile, Fs, path):
    """
       Compute speech quality metrics between clean and enhanced signals.

       Args:
           clean_signal: Clean speech signal or file path
           enhanced_signal: Enhanced speech signal or file path
           sample_rate: Sampling rate
           is_file_path: Whether inputs are file paths (True) or arrays (False)

       Returns:
           Tuple of metrics: (pesq_mos, CSIG, CBAK, COVL, segSNR, STOI)
       """
